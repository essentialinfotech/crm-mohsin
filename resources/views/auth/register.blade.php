			...
			<div class="login login-2 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
							...
							<div class="login-form login-signin py-11">
								...
								<form class="form"  method="post" action="{{ route('register') }}">
									...
									<div class="text-center pb-8">
										...
										<a href="" class="text-primary font-weight-bolder">if You have an account please Login here</a></span>
									</div>
									<!--end::Title-->
									<!--begin::Form group-->
									...
									<div class="text-center pt-2">
										<button type="submit" class="btn btn-dark font-weight-bolder font-size-h6 px-8 py-4 my-3">Sign Up</button>
									</div>
									<!--end::Action-->
								</form>
								<!--end::Form-->
				...
				<div class="content order-1 order-lg-2 d-flex flex-column w-100 pb-0" style="background-color: #B1DCED;">
					...
					<div class="d-flex flex-column justify-content-center text-center pt-lg-40 pt-md-5 pt-sm-5 px-lg-0 pt-5 px-7">
						<h3 class="display4 font-weight-bolder my-7 text-dark" style="color: #986923;">CRM in Essential Infotech</h3>
