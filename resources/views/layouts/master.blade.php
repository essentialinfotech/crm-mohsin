...
.slider.round:before {
  border-radius: 50%;
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading" style="margin-bottom: 500px;">
		<!--begin::Main-->
		<!--begin::Header Mobile-->
							...
							<ul class="menu-nav">
								<li class="menu-item menu-item-active" aria-haspopup="true">
									<a href="{{route('admin.dashboard')}}" class="menu-link">
										...
										<span class="menu-text">{{ __('file.dashboard') }}</span>
									</a>
								</li>
								...
								<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										...
										<span class="menu-text">{{__('file.product')}}</span>
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											...
											<li class=" menu-item{{ request()->is('category') ? 'active' : ''}}" aria-haspopup="true">
												<a href="{{route('category.index')}}" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">{{__('file.category')}}</span>
												</a>
											</li>
											<li class="menu-item {{ request()->is('brand') ? 'active' : ''}}" aria-haspopup="true">
												<a href="{{route('brand.index')}}" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">{{trans('file.Brand')}}</span>
												</a>
											</li>
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="{{route('admin.details')}}" class="menu-link">
													...
													<span class="menu-text">Update Details</span>
												</a>
											</li>
											<li class="menu-item" aria-haspopup="true">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="{{route('bank.show.details')}}" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">Bank details show</span>
												</a>
											</li>
											<li class="menu-item" aria-haspopup="true">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="{{route('users.show')}}" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">Show User</span>
												</a>
											</li>
											<li class="menu-item" aria-haspopup="true">
												<a href="{{route('show.cusromers.deatils')}}" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
								...
								<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										...
										<span class="menu-text">Area Calculation</span>
										<i class="menu-arrow"></i>
									</a>
									<div class="menu-submenu">
										<i class="menu-arrow"></i>
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="{{route('calculation.index')}}" class="menu-link">
													...
													<span class="menu-text">Enter Calculation</span>
												</a>
											</li>
											<li class="menu-item" aria-haspopup="true">
												<a href="{{route('calculation.show')}}" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">Calculation Show</span>
												</a>
											</li>
								...
								<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										...
										<span class="menu-text">{{__('file.settings')}}</span>
										<i class="menu-arrow"></i>
									</a>
									<div class="menu-submenu">
										<i class="menu-arrow"></i>
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="{{route('tax.index')}}" class="menu-link">
													...
													<span class="menu-text">{{trans('file.Tax')}}</span>
												</a>
											</li>
											<li class="menu-item" aria-haspopup="true">
												<a href="{{route('setting.general')}}" class="menu-link">
													...
													<span class="menu-text">{{trans('file.General Setting')}}</span>
												</a>
											</li>
